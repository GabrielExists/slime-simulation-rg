...
pub const AGENT_STATS: [AgentStatsAll; NUM_AGENT_TYPES] = [
    // Green
    AgentStatsAll {
        spawn_mode: SpawnMode::CircumferenceFacingOutward { distance: 80.0 },
        num_agents: 4_000,
        shader_stats: AgentStats {
            ...
            attraction_channel_one: 0.6,
            attraction_channel_two: 1.0,
        },
    },
    // Blue
    AgentStatsAll {
        spawn_mode: SpawnMode::CircumferenceFacingOutward { distance: 120.0 },
        num_agents: 10_000,
        shader_stats: AgentStats {
            velocity: 65.0,
            turn_speed: PI * 80.0,
            ...
            sensor_offset: 5.0,
            pixel_addition: 1.0 / 5.0,
            avoidance_threshold: 100.0,
            attraction_channel_one: -1.0,
            attraction_channel_two: 0.6,
        },
    },
];

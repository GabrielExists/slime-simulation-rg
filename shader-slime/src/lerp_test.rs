...
mod tests {
    ...
    fn test_pow_size_f64() {
        ...
        let expected_pairs = vec![
            ...
            (1048576, 63.212073424720366),
            (2097152, 63.21206465378847),
            (4194304, 63.21206026832219),
            (8388608, 63.212058075583535),
            (16777216, 63.21205697922535),
            (33554432, 63.212056431031804),
            (67108864, 63.2120561569609),
            (134217728, 63.212056019884045),
            (268435456, 63.21205595137196),
            (536870912, 63.212055917123216)];
    ...
    fn test_pow_size_overshoot_f64() {
        ...
        let expected_pairs = vec![(1, 200.0),
                                  (2, 100.0),
                                  (4, 93.75),
                                  (8, 89.98870849609375),
                                  ...
                                  (1048576, 86.46649748950487),
                                  (2097152, 86.4664845829164),
                                  (4194304, 86.46647812963273),
                                  (8388608, 86.46647490298187),
                                  (16777216, 86.46647328966127),
                                  (33554432, 86.46647248300508),
                                  (67108864, 86.46647207964659),
                                  (134217728, 86.46647187799466),
                                  (268435456, 86.46647177716167),
                                  (536870912, 86.46647172674206)]
            ;
